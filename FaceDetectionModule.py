...
class FaceDetector():
    ...
    def fancyDraw(self, img, bbox, l=30, t=5, rt=1):
        ...
        cv2.putText(img, predicted_name, (x, y), cv2.FONT_HERSHEY_PLAIN, 1, (255, 0, 255), 2)
        '''
...
def main():
    ...
    while True:
        ...
        #img =cv2.imread(r"C:\Users\Akanksha Singh\PycharmProjects\CVPytho\test_img\10.jpeg")
